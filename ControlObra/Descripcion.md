...
Aunque los trabajadores pueden ingresar y salir varias veces durante la jornada laboral, cada desplazamiento debe
registrarse y cumplir con las normas operativas y de seguridad.
...
- **Restricción por Cumpleaños**: Solo empleados que cumplan años ese dia pueden ingresar.
- **Restricción por Nombre**: Solo empleados que csu nombre comienza con cierta letra pueden ingresar.

El sistema debe validar que el trabajador cumpla **todas** las reglas activas para ese dia en la obra para su ingreso.
...
Cuando un trabajador alcanza el **100% de avance acumulado**, queda automáticamente bloqueado y **no puede volver a
ingresar** a la obra, independientemente de las reglas del día.
